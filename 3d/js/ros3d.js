...
ROS3D.UrdfClient = function(options) {
  ...
  getParam.get(function(string) {
    ...
    urdf.name = "robot_model";
    that.rootObject.add(urdf);
  });
};
...
ROS3D.Viewer = function(options) {
  ...
  this.directionalLight = new THREE.DirectionalLight(0x000000, intensity);
...
//     this.scene.add( light4 );
  ...
  function draw() {
    ...
    that.directionalLight.position = that.camera.localToWorld(new THREE.Vector3(0, 0, 0));
